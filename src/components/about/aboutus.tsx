  ...
  return (
    ...
    <Client><AlrExpand title={<Question ques="What is the Computer Science Society? And What does it do?"/>} content={<Answer ans={
      ...
      <ToExpand title={<Question ques="What are the benefits of joining the Computer Science Society?"/>} content={<Answer ans={
        <p> Networking Opportunities: Engage with fellow enthusiasts in the field, collaborate on projects, sharing ideas, and connect as part of a community. <br /> <br/>
        Skill Development: Enhance your coding and technical skills while contribution to event planning, workshops, hackathons. Get the chance to make a tangible impact in STEM from the ground up. <br /> <br/>
        Exclusive access to Society Events: Enjoy member-exclusive access to workshops, meetings, and more. Also join in on fun events like game nights, coding opps, discussions! <br /><br/>
        External Reach: Interact with other CS Societies nationwide, and internationally. Gain valuable industry insights through interactions with professionals in the field. <br />
