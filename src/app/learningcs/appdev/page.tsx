...
export default function appdev(){
    return(
      ...
      <div>
        <Resource img = "" resource="APP DEVELOPMENT" info={
          <p> Get started with app development with <a href="https://docs.flutter.dev/get-started/codelab" className="text-secondary underline"> Flutter. </a> </p>
        } />
      </div>
      </main>
        </>
