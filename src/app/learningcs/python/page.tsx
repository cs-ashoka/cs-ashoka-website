    ...
    return(
      ...
      <div>
        ...
        <p>
          ...
          <br></br><br></br>
          After this, Microsoft has various Python modules that are a great way to get into specifics! <a href="https://learn.microsoft.com/en-us/training/paths/beginner-python/" className="text-secondary underline"> Here&apos;s one!</a> You can look into more <a href="https://learn.microsoft.com/en-us/training/browse/?terms=python" className="text-secondary underline"> here</a>.
          <br></br><br></br>
          Or, you can also refer to the workshop conducted by the Computer Science Society (by 2024 President, Aryan Nath) which goes over install and basics. The link will be in your inbox soon!  
        </p>
        </>}/>
      </div>
      </main>
