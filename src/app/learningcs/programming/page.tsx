      ...
      <div>
        <Resource img={""} resource="GETTING STARTED" info={
          ...
          <p>
            ...
            <br></br> <br></br>
            (c.) <span className="font-bold">Java:</span> Java is like a Swiss Army knife (and is NOT JavaScript) for making computer programs. It&apos;s used to build all sorts of applications: from mobile apps to video games. This is because Java programs can be run on any platform that supports Java, without changing the source code much. Java programs are translated into bytecode and aren&apos;t directly translated to machine code. After this, they can be run on any machine that supports JVM (Java Virtual Machine) without having to recompile or rewrite it. 
            <br></br>
