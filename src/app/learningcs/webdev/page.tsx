    ...
    return(
      ...
      <div>
        <Resource img={""} resource="WEB DEVELOPMENT" info={<>
          ...
          <a href="https://youtu.be/W6NZfCO5SIk?si=1dnZ1lkH3KDSwDUB" className="text-secondary underline"> Learn Javascript</a> with this 1 hour long tutorial by Programming with Mosh that starts from scratch and assumes no prior experience. This YouTube Channel in general is a great resource for basic tutorials!  
          <br></br>
          ...
          <br></br>
           <a href="https://codepip.com/games/grid-garden/" className="text-secondary underline"> A game </a> to better acquaint yourself with CSS & Tailwind CSS: Tailwind CSS allows you to directly compose classes in your HTML markup, allowing you to speed up the development process, as compared to writing CSS from scratch in a separate file. 
          <br></br>
          ...
          <br></br>
          After the 100 seconds, the <a href="https://tailwindcss.com/docs/utility-first" className="text-secondary underline">Tailwind documentation</a> is a very good resource and is easy to navigate: 
